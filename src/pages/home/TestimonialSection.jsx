...
const testimonials = [
  {
    id: 1,
    name: "Peter Parker",
    avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=PeterParker&backgroundColor=blue,red&accessoriesType=Blank&topType=ShortHairShortFlat&clotheType=Hoodie&clotheColor=Red&eyeType=Default&eyebrowType=Default&mouthType=Smile", // Comic-style avatar
    location: "New York",
    rating: 5,
  ...
  },
  {
    id: 2,
    name: "Bruce Wayne",
    avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=BruceWayne&backgroundColor=black,gray&accessoriesType=Blank&topType=ShortHairShortFlat&clotheType=BlazerShirt&clotheColor=Black&eyeType=Default&eyebrowType=Default&mouthType=Serious", // Comic-style avatar
  ...
  },
  {
    id: 3,
    name: "Diana Prince",
    avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=DianaPrince&backgroundColor=yellow,orange&accessoriesType=Blank&topType=LongHairStraight&clotheType=Blouse&clotheColor=Yellow&eyeType=Default&eyebrowType=Default&mouthType=Smile", // Comic-style avatar
    location: "Themyscira",
    rating: 4,
  ...
  },
  {
    id: 4,
    name: "Tony Stark",
    avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=TonyStark&backgroundColor=red,orange&accessoriesType=Blank&topType=ShortHairShortFlat&clotheType=BlazerShirt&clotheColor=Red&eyeType=Default&eyebrowType=Default&mouthType=Smile", // Comic-style avatar
    location: "Malibu",
    rating: 5,
