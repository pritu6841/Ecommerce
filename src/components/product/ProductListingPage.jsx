...
const sampleProducts = [
...

  {
    ...
    price: 799,
    image: "https://i.pinimg.com/originals/2e/2e/7e/2e2e7e2e7e2e7e2e7e2e7e2e7e2e7e2e.jpg",
    rating: 4.2,
    category: "Women",
    subcategory: "Graphic Printed",
    isNew: false,
  ...
  },
  {
    ...
    price: 849,
    image: "https://i5.walmartimages.com/asr/8e8e8e8e-8e8e-8e8e-8e8e-8e8e8e8e8e8e_1.8e8e8e8e8e8e8e8e8e8e8e8e8e8e8e8e.jpeg",
    rating: 4.6,
    category: "Women",
    subcategory: "Crop Tops",
    isNew: true,
  ...
  },
  {
    ...
    price: 899,
    image: "https://cdn.shopify.com/s/files/1/0253/6561/0604/products/shehulk-tee.jpg?v=1629391234",
    rating: 4.3,
    category: "Women",
    subcategory: "Graphic Printed",
    isNew: false,
  ...
  },
  {
    ...
    price: 1099,
    image: "https://i5.walmartimages.com/asr/9b9b9b9b-9b9b-9b9b-9b9b-9b9b9b9b9b9b_1.9b9b9b9b9b9b9b9b9b9b9b9b9b9b9b9b.jpeg",
    rating: 4.7,
    category: "Women",
    subcategory: "Hoodies",
    isNew: true,
  ...
  },
  {
    ...
    price: 799,
    image: "https://cdn.shopify.com/s/files/1/0253/6561/0604/products/storm-tee.jpg?v=1629391234",
    rating: 4.4,
    category: "Women",
    subcategory: "Graphic Printed",
    isNew: false,
  ...
  },
  {
    ...
    price: 899,
    image: "https://cdn.shopify.com/s/files/1/0253/6561/0604/products/scarletwitch-tee.jpg?v=1629391234",
    rating: 4.8,
    category: "Women",
    subcategory: "Graphic Printed",
    isNew: true,
  ...
  },
  {
    ...
    price: 849,
    image: "https://i5.walmartimages.com/asr/7c7c7c7c-7c7c-7c7c-7c7c-7c7c7c7c7c7c_1.7c7c7c7c7c7c7c7c7c7c7c7c7c7c7c7c.jpeg",
    rating: 4.1,
    category: "Women",
    subcategory: "Crop Tops",
    isNew: false,
  ...
  },
  {
    ...
    price: 799,
    image: "https://cdn.shopify.com/s/files/1/0253/6561/0604/products/raven-tee.jpg?v=1629391234",
    rating: 4.5,
    category: "Women",
    subcategory: "Graphic Printed",
    isNew: true,
  ...
  },
  {
    ...
    price: 899,
    image: "https://cdn.shopify.com/s/files/1/0253/6561/0604/products/jeangrey-tee.jpg?v=1629391234",
    rating: 4.6,
    category: "Women",
    subcategory: "Graphic Printed",
    isNew: false,
  ...
  },
  {
    ...
    price: 1099,
    image: "https://i5.walmartimages.com/asr/6a6a6a6a-6a6a-6a6a-6a6a-6a6a6a6a6a6a_1.6a6a6a6a6a6a6a6a6a6a6a6a6a6a6a6a.jpeg",
    rating: 4.7,
    category: "Women",
    subcategory: "Hoodies",
    isNew: true,
  ...
  if (urlCategory) {
    if (urlCategory.toLowerCase() === 'men') {
      ...
      filteredProducts = sampleProducts.filter(
        p => p.category && ['marvel', 'dc'].includes(p.category.trim().toLowerCase())
      );
    } else {
      filteredProducts = sampleProducts.filter(
        p => p.category && p.category.trim().toLowerCase().includes(urlCategory.toLowerCase())
      );
    }
  }
