            ...
            {categories.map((category, index) => (
              ...
              >
                <div className="aspect-square overflow-hidden">
                  <img
                    src={category.image || "https://images.unsplash.com/photo-1512436991641-6745cdb1723f"}
                    alt={category.name}
              ...
              >
                <div className="bg-black/40 backdrop-blur-md border border-blue-900/50 rounded-xl overflow-hidden shadow-[0_0_15px_rgba(0,191,255,0.3)]">
                  ...
                  <div className="relative aspect-[3/4] overflow-hidden">
                    <img
                      src={product.image || "https://images.unsplash.com/photo-1512436991641-6745cdb1723f"}
                      alt={product.name}
                      className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110"
                    />
